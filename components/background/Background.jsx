...
export const Background = ({ children, ...props }) => (
  <div
    ...
    {...props}
  >
    <div className="fixed -top-16 -left-16 h-72 w-72 md:-top-32 md:-left-32 md:h-96 md:w-96 bg-tertiary rounded-full"></div>
    <div className="z-20 w-full">
      <DropdownMenu />
    </div>

    <div className="flex fixed flex-row -bottom-24 -right-24 h-96 w-96 md:h-128 md:w-128 bg-secondary rounded-full">
      <text
