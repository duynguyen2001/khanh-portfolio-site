...
export const Background = ({ children, ...props }) => (
  ...
  >
    <div
      className="fixed  -bottom-24 -right-24 border-2 border-black h-96 w-96 md:h-128 md:w-128 dark:invert rounded-full"
      style={{
    ...
    >
      <text
        className="font-nom text-6xl lg:text-7xl px-10 text-primary"
    ...
    <div className="w-full z-20 md:w-5/6 xl:w-3/4 "
    style={{
      boxShadow: "0 8px 32px 0 rgba( 31, 38, 135, 0.37 )",
